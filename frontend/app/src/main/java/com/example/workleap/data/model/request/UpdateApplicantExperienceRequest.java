...
public class UpdateApplicantExperienceRequest {
    ...
    public UpdateApplicantExperienceRequest() {}

    public UpdateApplicantExperienceRequest(String companyName, String companyLink, String position, Date workStart, Date workEnd, String jobResponsibility, String moreInfo, List<String> achievement) {
