...
public class CreateApplicantSkillRequest {
    ...
    public CreateApplicantSkillRequest() {};
    public CreateApplicantSkillRequest(String skillName, String description, String certificate, String expertiseLevel, Integer yearOfExp, Integer monthOfExp) {
