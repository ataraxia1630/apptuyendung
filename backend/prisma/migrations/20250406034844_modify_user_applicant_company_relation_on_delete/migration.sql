...
-- CreateEnum
CREATE TYPE "ReactionType" AS ENUM ('LIKE', 'LOVE', 'HUHU', 'ANGRY', 'WOW');
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_postId_fkey" FOREIGN KEY ("postId") REFERENCES "JobPost"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
